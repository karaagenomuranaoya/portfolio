        ...
        <div className="space-y-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            ...
            <InfoCard 
              ...
              title="AIは部下？"
              desc="僕にとってAIは相棒であり、友人です。アイデアを伝えても頓珍漢なコードを出すこともあります。そんな時には「惜しい！」「もうちょいこうしたいな」エールを送り、できたら「完璧！」「よくやった！」一緒に喜びます。（「AIが持つコンテキストに評価を下すことでアウトプットの質が高まる」というのももちろんありますが、だって作ってて楽しいじゃないですか！）"
            />
            <InfoCard 
